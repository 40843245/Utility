...
if __name__=='__main__':
    ...
    widget1 = Widget()
    widget1.setLayout(widget1.mainLayout)
    ...
    widget1.mainLayout.setSizeConstraint(QLayout.SetMinimumSize)
    widget1.keyPressEater.SetRoot(widget1)
    widget1.show()
    
    widget2 = Widget()
    widget2.setLayout(widget2.mainLayout)
    widget2.setGeometry(QRect(300,100,200,600))
    widget2.installEventFilter(widget2.keyPressEater)
    widget2.keyPressEater.SetRoot(widget2)
    widget2.show()
    
    windowsMap = {
        widget1.window() : widget1 , 
        widget2.window() : widget2
    }
    
    widget1.keyPressEater.SetWindows(windowsMap)
    widget2.keyPressEater.SetWindows(windowsMap)
